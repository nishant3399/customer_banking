...
def main():
    ...
    print("Interest earned on Savings account: $", format(interest_earned, ".2f"))
    print("Updated Savings account balance: $", format(updated_savings_balance, ".2f"))
    
    # Prompt the user to set the CD balance, interest rate, and months for the CD account.
    cd_balance = float(input("Enter initial CD account balance $"))
    ...
    print("Interest earned on CD account: $", format(interest_earned, ".2f"))
